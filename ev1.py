...
def mainroot():
	...
	root.title("event management sysyem")
	#--------------seperator-------------------------------------------------------------------------------------------------------------------
	...
	img = ImageTk.PhotoImage(Image.open("newestbg5.jpg"))
	...
	def hotel_status():
		...
		img = ImageTk.PhotoImage(Image.open("newbg6lf.jpg"))
